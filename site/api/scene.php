...
function pd_scene_spec() {
  return array(
    ...
    'stickrx'   => array(0.3, 2),      // ход руля по горизонтали: 1 = край ручки — край экрана
    'stickry'   => array(0.3, 2),      // …и по вертикали
    'stickexpo' => array(0, 1),        // доля квадратичной составляющей в кривой руля
    // stickx/sticky (скорость руля, v2-v4) убраны 24.08.2026 вместе с самой схемой
    // «руль = скорость»: у старых сохранённых наборов эти ключи ещё лежат в данных,
