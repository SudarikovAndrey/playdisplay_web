...
function pd_scene_spec() {
  return array(
    ...
    'stickrx'   => array(0.5, 3),      // чувствительность руля v6 (относительный тач): пиксели полёта на пиксель пальца
    'stickry'   => array(0.5, 3),      // …и по вертикали
    // stickx/sticky (скорость, v2-v4) и stickexpo (кривая, v5) убраны вместе со своими
    // схемами руля: у старых сохранённых наборов эти ключи ещё лежат в данных,
    // клиент их просто не читает
  );
}
