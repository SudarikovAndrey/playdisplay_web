 ...
 */
/**
 * Уйдёт ли письмо ПО-НАСТОЯЩЕМУ. Возвращает array(готов, причина).
 *
 * Зачем отдельная проверка. Драйвер file честно сохраняет письмо в api/outbox и честно
 * отвечает «успех» — а на почту при этом не приходит ничего. Снаружи это выглядит как
 * «бриф отправлен», и запрос теряется молча. Ровно так и случилось 04.08.2026: разговор
