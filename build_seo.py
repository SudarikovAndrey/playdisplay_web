...
ORG_DESC = ('PlayDisplay — студия интерактивного опыта. Проектируем мультимедийные '
            'инсталляции, голограммы, дополненную реальность и выставочные пространства '
            'для музеев, корпораций и выставок. Превращаем пространство в игру.')
SOCIALS = [
...
<main class="wrap">
  ...
  <footer>
    <p>PlayDisplay — студия интерактивного опыта. Мультимедийные инсталляции, голограммы, дополненная реальность.</p>
